...
public class SunmiPrintHelper {
    ...
    //         sunmiPrinterService.printText("Test proof\n", null);
    ...
    //         }
    //         sunmiPrinterService.printTextWithFont("Note: This is a custom small ticket style example, developers can follow this to build their own\n",
    //                 null, 12, null);
    //         if(paper == 1){
    //             sunmiPrinterService.printText("--------------------------------\n", null);
    //         }else{
    ...
    //                     null);
    //         }
    //         sunmiPrinterService.printTextWithFont("total:          59¥\b", null, 40, null);
    //         sunmiPrinterService.setAlignment(1, null);
    //         sunmiPrinterService.printQRCode("Thank you for your patronage", 10, 0, null);
    //         sunmiPrinterService.setFontSize(36, null);
    //         sunmiPrinterService.printText("Thank you for your patronage", null);
    //         sunmiPrinterService.autoOutPaper(null);
    //      } catch (RemoteException e) {
    //         e.printStackTrace();
    //     }
