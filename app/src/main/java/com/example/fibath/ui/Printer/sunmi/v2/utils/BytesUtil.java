...
public class BytesUtil {
	...
	// Byte array combination operationOne
	...
	// Byte array combination operationTwo
	...
	/**
	 * Convert a bitmap image into a raster bitmap with a width and height of the first four bits
	 */
	...
	/**
	 * Convert bitmap to N points of row data specified by mode
	 */
	...
	/**
	 * Baidu ticket (Baidu ticket for ESC cmd）
	 */
	...
	/**
	 * Meituan Ticket (Meituan ticket for ESC cmd）
	 */
	...
	/**
	 * Are you hungry? (Eleme ticket for ESC cmd）
	 */
	...
	/**
	 * Word of Mouth Ticket (KouBei ticket for ESC cmd）
	 */
	...
	public static byte[] customData(){
		byte[] rv = new byte[]{
				...
				// Printer self-test（printer selfcheck）
				0x1F, 0X1B, 0x1F, 0x53,
				// Initialize the printer （printer init）
				0x1B, 0x40,
				...
				0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x0A,
				// Set character right margin （Set character right margin）
				...
				0x3D, 0x3D, 0x3D, 0x3D,0x3D, 0x3D, 0x3D, 0x3D,0x3D, 0x3D, 0x3D, 0x3D,0x3D, 0x3D, 0x3D, 0x3D,0x3D, 0x3D, 0x3D, 0x3D,0x3D, 0x3D, 0x3D, 0x3D,0x3D, 0x3D, 0x3D, 0x3D,0x3D, 0x3D, 0x3D, 0x3D, 0x0A,
				// Font effect Shangmi Technology
				// Set bold, double height, double width, underline, highlight （Set bold, double height, double width, underline, highlight）
				...
				0x2A, 0x2A, 0x2A, 0x2A,0x2A, 0x2A, 0x2A, 0x2A,0x2A, 0x2A, 0x2A, 0x2A,0x2A, 0x2A, 0x2A, 0x2A,0x2A, 0x2A, 0x2A, 0x2A,0x2A, 0x2A, 0x2A, 0x2A,0x2A, 0x2A, 0x2A, 0x2A,0x2A, 0x2A, 0x2A, 0x2A, 0x0A,
				// Layout position
				// Set absolute position and set relative position (Absolute and relative positions）
				...
				// Set print area width	（Printing area width)
				...
				0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D, 0x0A,
				// Print and feed (printing and feed paper)
				...
				0x1B, 0x61, 0x00,
				// Dividing line (The method for printing raster bitmaps will be implemented later, again using 1b 61 01 to center before）
				0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D, 0x2D,0x2D,0x2D,0x2D,0x2D, 0x0A,
	...
	// Partial line marks for partial character printing
